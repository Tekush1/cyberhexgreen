...
import { ShoppingCart, Package, Truck, Users, Star, ArrowRight, Database, MapPin } from 'lucide-react';
  ...
  const problemStatements = [
    {
      ...
      description: "Build a comprehensive grocery delivery platform with real-time tracking and inventory management.",
    ...
    {
      id: 2,
      title: "Admin & Delivery Dashboard",
      description: "Create an admin panel for managing inventory, orders, delivery personnel, and analytics.",
      techStack: ["React", "Express", "Redis", "Google Maps API"],
      difficulty: "Advanced",
      impact: "Operations",
      features: [
        "Inventory control",
    ...
    <div className="min-h-screen bg-dark-300 py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            Build a complete grocery delivery solution with real-time tracking
          </motion.p>
        </div>
